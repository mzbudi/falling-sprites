...
export default function ForceConnectWalletModal({
  onAccept,
}: {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      ...
      >
        <h2 className="text-3xl font-bold italic text-black mb-4 tracking-widest"></h2>
        <ul className="text-gray-800 text-left text-lg italic font-medium space-y-3 mb-6">
          Please Connect Your Wallet for Playing the Game!
        </ul>
        <button
          onClick={() => handleClick()}
